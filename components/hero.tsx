  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          The{" "}
          <span className="text-[#0054a6] font-semibold">Ross</span>{" "}
        ...
        >
          Discover how people are saving on brand-name clothing, shoes, home decor, and everyday finds.
        </p>
        ...
        >
          <a
            href="https://trksy.org/aff_c?offer_id=2786&aff_id=26188"
            target="_blank"
